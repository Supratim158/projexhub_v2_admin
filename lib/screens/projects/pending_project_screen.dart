...
class _PendingProjectsScreenState extends State<PendingProjectsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Fetch once
    projectController.fetchPendingProjects();
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4),
                    Text(
                      "Review and manage incoming project submissions from the community.",
                      style: TextStyle(
                        color: Colors.grey,
                        fontSize: 14,
                      ),
                    ...
                    const Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(flex: 1, child: Center(child: Text("REVIEW", style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold, fontSize: 12, letterSpacing: 1.2)))),
                        ],
                      ),
                    ),
                                    ...
                                    child: Row(
                                      children: [
                                        Container(
                                          ...
                                          child: const Icon(Icons.architecture, color: Color(0xff4B39EF)),
                                        ),
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: const Row(
                                            ...
                                            children: [
                                              Icon(Icons.circle, color: Color(0xffEA580C), size: 6),
                                              SizedBox(width: 6),
                                              Text("Pending", style: TextStyle(color: Color(0xffEA580C), fontWeight: FontWeight.bold, fontSize: 11)),
                                            ],
                                          ),
                                        ),
                                      ],
                                  ...
                                  Expanded(
                                    ...
                                    child: Center(
                                      child: TextButton(
                                        ...
                                        child: const Text("Review", style: TextStyle(color: Color(0xff4B39EF), fontWeight: FontWeight.bold, fontSize: 12)),
                                      ),
                                    ),
                                  ),
                                ],
                    ...
                    Padding(
                      ...
                      child: Obx(() {
                        ...
                        return Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text("Showing $startItem-$endItem of $totalItems pending projects", style: const TextStyle(color: Colors.grey, fontSize: 13)),
                            Row(
                              children: [
                                IconButton(
